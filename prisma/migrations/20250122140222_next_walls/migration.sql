...
-- AddForeignKey
ALTER TABLE `ColorPalette` ADD CONSTRAINT `ColorPalette_wallpaperId_fkey` FOREIGN KEY (`wallpaperId`) REFERENCES `wallpapers`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
